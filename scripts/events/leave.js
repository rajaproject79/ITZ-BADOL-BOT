...
module.exports.onLoad = function () {
  ...
  const path = join(__dirname, "cache", "left", "video");
  if (existsSync(path)) mkdirSync(path, { recursive: true });	

  const path2 = join(__dirname, "cache", "left", "video");
